...
Баланс, история и реквизиты остаются прежними. В v3 и v4 такое означало новый кошелёк и переезд всех средств.

### 255 переводов за одну транзакцию

Одна подпись, одна комиссия сети, до 255 получателей. Зарплаты, выплаты,
раздачи — всё уходит одним пакетом. Получателей вводят по одному или
вставляют готовым списком «адрес сумма»; сумма и комиссия видны до подписи.
